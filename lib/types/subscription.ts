 ...
 */
export function getTierFromId(tierId: string | null | undefined): SubscriptionTier {
 ...
 */
export function isWithinFileLimit(currentFiles: number, newFiles: number, limits: TierLimits): boolean {
 ...
 */
export function isWithinPageLimit(totalPages: number, limits: TierLimits): boolean {
 ...
 */
export function getRemainingFiles(currentFiles: number, limits: TierLimits): number {
 ...
 */
export function getRemainingPages(currentPages: number, limits: TierLimits): number {
